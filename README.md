...
[![GitHub Actions Linting Status](https://github.com/nf-core/pixelator/workflows/nf-core%20linting/badge.svg)](https://github.com/nf-core/pixelator/actions?query=workflow%3A%22nf-core+linting%22)
...
[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23pixelator-4A154B?labelColor=000000&logo=slack)](https://nfcore.slack.com/channels/pixelator)
...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```console
    nextflow run nf-core/pixelator -profile test,YOURPROFILE
    ```
...
4. Start running your own analysis!
    ...
    ```console
    nextflow run nf-core/pixelator -profile <docker/singularity/podman/shifter/charliecloud/conda/institute> --input samplesheet.csv --genome GRCh37
    ```
